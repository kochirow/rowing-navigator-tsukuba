...
> **出自と承認。** この13項目は `d2b32cb`(2026-07-30)で12項目が一括して文書化され、
> 13項目目が後から足されたものである。**2026-09-02 に利用者が全項目を読み、
> 自身の判断と整合することを確認した。** したがってこれは
> 「エージェントが書いた覚書」ではなく、**利用者が承認した規範**として扱ってよい。
> 変更を提案する場合は利用者の判断を仰ぐこと。勝手に緩めない。
